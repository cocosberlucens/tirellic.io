...
$$
\mathbf{v} \cdot \mathbf{v} = \sum_{i=1}^{n} \mathbf{v}_i \mathbf{v}_i = \sum_{i=1}^{n} \mathbf{v}_i^2 = |\mathbf{v}|^2\tag{1}
$$
...
$$
c^2=a^2 + b^2 - 2 a b \cos{(\theta_{a,b})}
$$
...
$$
|\mathbf{b}|^2 + |\mathbf{a}|^2 - 2(\mathbf{a} \cdot \mathbf{b}) = |\mathbf{a}|^2 + |\mathbf{b}|^2 - 2|\mathbf{a}||\mathbf{b}| \cos({\theta_{\mathbf{a},\mathbf{b}}})
$$
that is to say 

$$
\mathbf{a} \cdot \mathbf{b} = |\mathbf{a}| |\mathbf{b}|\cos({\theta_{\mathbf{a},\mathbf{b}}})\tag{2}
$$
