...
remembering that, from rearranging the conditional probability formula $$P(A \cap B)=P(B|A) \cdot P(A)$$and
$$P(A \cap B)=P(A|B) \cdot P(B)$$
...
think of the *tested subject*, they have a chance of $1 \text{ in } 10\,000$ of having the disease and if they do, they have a $0.8$ chance of testing positive: $0.8 \cdot 0.0001 = 0.00008$: this is  $$P(\mathit{Positive}|D) \cdot P(D)$$at the same time, they have $9\,999 \text{ in } 10\,000$ chances of *not having* the disease and if they don't, they have $0.05$ chances of testing nonetheless positive: $0.05 \cdot 0.9999 = 0.049995$ and this is
$$P(\mathit{Positive}|\neg D) \cdot P(\neg D)$$
...
$$P(\mathit{Positive} \cap D) + P(\mathit{Positive} \cap \neg D)$$representing the microcosm of all positive tests, hence
